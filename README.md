...
![System Architecture](Images/ScanIoT_Web_Scan_Edit.png)
...
![System Architecture](Images/ScanIoT_Web_Saved_Pcap_Files.png)

*Figure 6: ScanIoT saved pcaps.*


![System Architecture](Images/ScanIoT_Web_Saved_Images.png)

*Figure 7: ScanIoT saved device images.*
...
<pre> Jamali, A.F. and Fung, C., 2024, October. ScanIoT, an Application to collect IoT dataset for HomeGuard. In 2024 7th Conference on Cloud and Internet of Things (CIoT) (pp. 1-2). IEEE. </pre>
